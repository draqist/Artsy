...
const ImageCard = () => {
  ...
  return (
    <Box w='calc(100%)' border='2px solid' borderColor='gray.600' p='6px' bgColor='linear-gradient(`180deg,rgba(35,37,49,.5),rgba(15,15,24,.5))'  backdropFilter='blur(104px)'  borderRadius='14px'>
      <Flex justifyContent='center' borderRadius='8px' w='100%' overflow='hidden' >
        <Image as ={motion.img} whileHover={{scale: 0.75, backgroundColor: 'rgba(0,0,0,0.6)'}}  src='/profile3.jpeg'   borderRadius='8px' alt='profile-image'/>
      </Flex>
    </Box>
  )
}
